...
The game is implemented in three files, a minimal wrapper .html file and a couple of script .js file. All the exciting HTML is created on the fly by the script.
